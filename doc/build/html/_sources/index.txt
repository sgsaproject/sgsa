...
O que?
================================
O SGSA (Sistema de Gestão de Semana Acadêmica) é um sistema para a gestão da Semana Acadêmica.
...
Por que?
================================
* Facilitar o controle e agilizar tanto para organização quanto para os participantes.
* Também para fornecer informações sobre o evento para todos.
* Tornar mais rápida a entrada dos paticipantes nas palestras/mini-cursos.
* Tornar mais rápida a inscrição dos participantes no evento.
* Controlar a entrada e saida dos participantes.
* Controlar as palestras.
* Controlar as salas e locais do evento.
* Gerar relatórios.
* Certificado de participação.
* Participantes por palestra.
* Palestras (dados das palestras).
* Participantes (dados dos participantes).</ul>
