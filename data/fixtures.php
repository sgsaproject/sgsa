...
if (APPLICATION_ENV == 'development' || APPLICATION_ENV == 'testing'):
    ...
    $db->insert('usuario', array('nome' => 'Paulo Quintana', 'email' => 'paulo@sacta.com', 'usuario' => 'pauloquinta', 'senha' => 'senhadopaulo', 'rg' => '1231231231', 'curso' => 'Engenhria de Telecomunicações', 'instituicao' => 'Unipampa', 'pagamento' => 'naopago', 'impresso' => 0, 'codigo_barras' => 84234, 'id_tipo_usuario' => 2));
    $db->insert('usuario', array('nome' => 'José Pereira', 'email' => 'jose@sacta.com', 'usuario' => 'jose', 'senha' => 'jose', 'rg' => '444343444', 'curso' => 'Ciência da Computação', 'instituicao' => 'Unipampa', 'pagamento' => 'naopago', 'impresso' => 0, 'codigo_barras' => 28759, 'id_tipo_usuario' => 1));
