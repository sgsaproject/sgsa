...
if (APPLICATION_ENV == 'development' || APPLICATION_ENV == 'testing'):
    ...
    $db->insert('usuario', array('nome' => 'João da Silva', 'email' => 'joaodasilva@sacta.com', 'senha' => '12345', 'rg' => '1234554321', 'curso' => 'Engenhria Mecânica', 'instituicao' => 'Unipampa', 'pagamento' => Application_Model_Usuario::NAO_PAGO, 'impresso' => 0, 'codigo_barras' => 97885, 'id_tipo_usuario' => 4));
    $db->insert('usuario', array('nome' => 'Maria Josefina', 'email' => 'mariajs@sacta.com', 'senha' => 'maria', 'rg' => '0987654321', 'curso' => 'Engenhria Civil', 'instituicao' => 'Unipampa', 'pagamento' => Application_Model_Usuario::NAO_PAGO, 'impresso' => 0, 'codigo_barras' => 98534, 'id_tipo_usuario' => 4));
    $db->insert('usuario', array('nome' => 'Pedro Barbosa', 'email' => 'pedrobb@sacta.com', 'senha' => 'senhadoida', 'rg' => '76767676767', 'curso' => 'Engenhria Elétrica', 'instituicao' => 'Unipampa', 'pagamento' => Application_Model_Usuario::NAO_PAGO, 'impresso' => 0, 'codigo_barras' => 54543, 'id_tipo_usuario' => 4));
    $db->insert('usuario', array('nome' => 'Paulo Quintana', 'email' => 'paulo@sacta.com', 'senha' => 'senhadopaulo', 'rg' => '1231231231', 'curso' => 'Engenhria de Telecomunicações', 'instituicao' => 'Unipampa', 'pagamento' => Application_Model_Usuario::NAO_PAGO, 'impresso' => 0, 'codigo_barras' => 84234, 'id_tipo_usuario' => 2));
    $db->insert('usuario', array('nome' => 'José Pereira', 'email' => 'jose@sacta.com', 'senha' => 'jose', 'rg' => '444343444', 'curso' => 'Ciência da Computação', 'instituicao' => 'Unipampa', 'pagamento' => Application_Model_Usuario::NAO_PAGO, 'impresso' => 0, 'codigo_barras' => 28759, 'id_tipo_usuario' => 1));
