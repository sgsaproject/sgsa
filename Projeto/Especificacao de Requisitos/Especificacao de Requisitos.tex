    ...
    \section{Introdução}
        ...
        \section{Requisitos Funcionais e Não-Funcionais Associados}
			...
			\subsubsection{Area do Participante}
				...
				\TabelaRequisito{Inscrição em palestras}{}
				...
				\TabelaRequisito{Adicionar participante em palestra}{}
				...
				\TabelaRequisito{Fechar participante em palestra}{}
				...
				\TabelaRequisito{Editar palestras do participante}{}
				...
				\TabelaRequisito{Importar participantes em palestra}{}
				...
				\TabelaRequisito{Alterar situação da palestra}{}
